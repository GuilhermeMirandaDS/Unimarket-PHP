...
<div class="modal-product">
    <div class="modal-title">
        ...
        <button><svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1.86667 18.6667L0 16.8L7.46667 9.33333L0 1.86667L1.86667 0L9.33333 7.46667L16.8 0L18.6667 1.86667L11.2 9.33333L18.6667 16.8L16.8 18.6667L9.33333 11.2L1.86667 18.6667Z" fill="#1D1B20"/></svg></button>
    </div>
    <div class="modal-content">
        <form action="post" class="add-product">
            ...
            <textarea name="desc" id="descProduct" placeholder="Digite a descrição do seu produto" required></textarea>
            ...
            <div class="box-upload">
                ...
                <p>ou</p>
                <input type="file" name="fotos" id="fotosProduct" accept="image/jpg" required>
            </div>
