...
<div class="site-main">
    ...
    <?php if (session()->getFlashdata('success')): ?>
        <div class="alerta-add" role="alert"><h2><?= session()->getFlashdata('success') ?></h2></div>
    <?php else: ?>
        <div class="alerta-add-erro" role="alert"><h2><?= session()->getFlashdata('error') ?></h2></div>
    <?php endif; ?>
                        ...
                        <div class="space-image">
                            <a href="<?= base_url('/products/' . $item->id) ?>">
                                <?php 
                                    ...
                                    $base_url_images = base_url('uploads/products/');
                                ?>
                        ...
                        <div class="product-info">
                            ...
                            <div class="product-footer">
                                ...
                                <div class="actions">
                                    ...
                                    <button class="btn-buy-card deleteProduct">
                                        <div class="hidden"><?= esc($item->id) ?></div>
...
<div class="modal-product">
    ...
    <div class="modal-content">
        <form action="/my-products/add" method="post" class="add-product" id="uploadForm" enctype="multipart/form-data">
            <?= csrf_field() ?>
            <div class="left">
                ...
                <div class="campo">
                    ...
                    <input type="text" name="preco" id="precoProdInput" placeholder="Ex.: 100.00" required>
                </div>
            </div>
