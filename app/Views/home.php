        ...
        <div class="container">
            <div class="swiper">
                <div class="swiper-wrapper">
                    ...
                    ?>
                        <?php
                            $banner = base_url('assets/img/banner-home-' . $i . '.jpg');
