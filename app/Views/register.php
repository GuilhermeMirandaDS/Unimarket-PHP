...
<body class="login-page">
    <div class="flex align-center content">
        ...
        <div class="form-login">
            ...
            <form method="post" action="<?= base_url('users/register') ?>" class="register aba" id="registerForm" enctype="multipart/form-data">
                ...
                <div class="options-aluno show">
                    ...
                    <div class="campo">
                        ...
                        <select name="curso" class="w-full border rounded p-2">
                            <option selected disabled>Seleciona um curso</option>
                            <?php foreach($cursos as $item): ?>
                                <option value="<?= $item->id ?>"><?= esc($item->nome) ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                </div>
                ...
                <div class="campo">
                    ...
                    <div class="box-upload">
                        ...
                        <p>ou</p>
                        <input type="file" name="image" id="pfpUpload" accept="image/*">
                    </div>
                </div>
